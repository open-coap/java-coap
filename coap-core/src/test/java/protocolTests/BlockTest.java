...
public class BlockTest {
    ...
    public void block1() throws Exception {
        ...
        transport.when(newCoapPacket(1).put().block1Req(0, BlockSize.S_32, true).size1(payload.length()).uriPath("/path1").contFormat(ContentFormat.TEXT_PLAIN).reqTag("65").payload("123456789012345|123456789012345|").build())
                .then(newCoapPacket(1).ack(Code.C231_CONTINUE).block1Req(0, BlockSize.S_32, true).build());

        transport.when(newCoapPacket(2).put().block1Req(1, BlockSize.S_32, false).uriPath("/path1").contFormat(ContentFormat.TEXT_PLAIN).reqTag("65").payload("dupa").build())
    ...
    public void block1_serverChangesBlockSize() throws Exception {
        ...
        transport.when(newCoapPacket(1).put().block1Req(0, BlockSize.S_32, true).size1(payload.length()).uriPath("/path1").contFormat(ContentFormat.TEXT_PLAIN).payload("123456789012345|123456789012345|").build())
        ...
        transport.when(newCoapPacket(2).put().block1Req(2, BlockSize.S_16, false).uriPath("/path1").contFormat(ContentFormat.TEXT_PLAIN).payload("dupa").build())
