...
class DefaultDuplicateDetectorCache implements PutOnlyMap<CoapRequestId, CoapPacket> {
    ...
    DefaultDuplicateDetectorCache(String cacheName,
            long maxSize,
    ...
    DefaultDuplicateDetectorCache(String cacheName, long duplicateDetectionTimeMillis, ScheduledExecutorService scheduledExecutor) {
        this(
                cacheName,
