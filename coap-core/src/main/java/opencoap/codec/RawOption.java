...
public final class RawOption implements Comparable<RawOption> {

    public final int optNumber;
    public final Opaque[] optValues;

    public static RawOption fromString(int num, String[] strArray) {
        Opaque[] bt;
        int skip = 0;
    ...
    public RawOption(int optNumber, Opaque[] optValues) {
        this.optNumber = optNumber;
        this.optValues = optValues;
    }

    public RawOption(int optNumber, Opaque singleOptValue) {
        this.optNumber = optNumber;
        this.optValues = new Opaque[1];
        this.optValues[0] = singleOptValue;
    }

    public Opaque getFirstValue() {
