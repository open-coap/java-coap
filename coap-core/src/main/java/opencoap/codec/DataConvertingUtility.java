...
public final class DataConvertingUtility {
    ...
    public static Opaque[] extendOption(Opaque[] orig, Opaque extend) {
    ...
    public static String extendOption(String orig, Opaque extend, String delimiter, boolean startWithDelimiter) {
